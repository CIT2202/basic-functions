...
// 1) Have a look in the example-functions.php file. The function printDetails() prints details about films.
// a) In this file write a line of code that will call the printDetails() function
...
// 7) Write your own function called isValidUsername(). 
// The function should accept a single argument, a string, and return a value of true if the string 6 characters or more in length and false if it isn't. 
// Have a look at http://php.net/manual/en/function.strlen.php for info on determining string length. Here's some example code that calls a isValidUsername() function. Uncomment this code code to check your function works.
...
//8) Write your own function called printList(). 
//   It should accept a single argument, an array, and output an HTML list, with each element in the array as an item in the list. 
//   It shouldn't return any values. Use this function to print out the returned values from getWinnersByContinent, getPositiveNumbers and filterImageFileNames.


//9) Write a calcAverage() function. 
